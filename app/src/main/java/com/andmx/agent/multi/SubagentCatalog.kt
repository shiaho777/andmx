...
object SubagentCatalog {
    ...
    fun createBuiltIns(
        ...
        return listOf(
            ...
            CustomSubAgent(
                ...
                systemPrompt = EXPLORE_READONLY_PROMPT,
    ...
    /** Verbatim read-only contract from the ZCode bundle (buildExploreAgentPrompt). */
    val EXPLORE_READONLY_PROMPT = """
...
Complete the user's search request efficiently and report your findings clearly.""".trimIndent()
