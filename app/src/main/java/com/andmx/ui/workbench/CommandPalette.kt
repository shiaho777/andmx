...
internal val DefaultCommandPaletteItems = listOf(
    ...
    CommandPaletteItem(CommandId.AUTOMATIONS, "自动化", "打开自动化工作台", listOf("automation", "schedule", "自动")),
    ...
    CommandPaletteItem(CommandId.OPEN_INSPECTOR, "打开 Agent 状态", "切到右侧 Inspector", listOf("inspector", "agent", "self", "state", "status", "状态", "自检")),
